...
import net.uaprom.jmorphy2.SuffixesDAWG;
...
public class KnownSuffixUnit extends AnalyzerUnit {
    ...
    class KnownSuffixParsedWord extends AnalyzerParsedWord {
        ...
        public List<ParsedWord> getLexeme() {
            ...
            String normalForm = wordPrefix + dict.buildNormalForm(suffixForm.paradigmId, suffixForm.idx, suffixForm.word);
            for (short idx = 0; idx < paradigmSize; idx++) {
                ...
                SuffixesDAWG.SuffixForm sf = new SuffixesDAWG.SuffixForm(suffixForm.word, (short) 0, suffixForm.paradigmId, idx);
